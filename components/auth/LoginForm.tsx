          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                className="pl-10 h-12 bg-gray-50 dark:bg-gray-700/50 border-0 rounded-xl focus:ring-2 focus:ring-indigo-500 transition-all duration-200"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                className="pl-10 pr-12 h-12 bg-gray-50 dark:bg-gray-700/50 border-0 rounded-xl focus:ring-2 focus:ring-indigo-500 transition-all duration-200"
                placeholder="••••••••"
              />
              <button
                type="button"
